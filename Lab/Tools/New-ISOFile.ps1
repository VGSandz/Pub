#source : credit to https://www.thelowercasew.com/create-an-iso-file-with-powershell
...
# Add all the files in the directory to be converted to iso.
#$dir_to_make_iso = "x:\path"

# Call the command to make the files into an ISO. Adjust the path accordingly.
#Get-ChildItem "$dir_to_make_iso" | New-ISOFile -path "y:\path\iso_file.iso"